<?php
// Include for php 7.4
//require_once __DIR__ . '/mysql_compat74.php';
...
final class _MysqlCompatLink {
    ...
    public function __construct(PDO $pdo, $hostInfo, $db) {
        $this->pdo = $pdo;
...
final class _MysqlCompatResult {
    ...
    public function __construct(array $rows, array $fields, $affected = 0) {
        $this->rows = $rows;
        $this->fields = $fields;
